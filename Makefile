...
setupsampledb:
	...
	mongoimport --host eecs484.eecs.umich.edu --username abrehob --password 12!4Tgooi6oo  -—collection users --db abrehob --file  sample.json --jsonArray

setupmydb:
	@echo "You must edit the following line in Makefile to correct the uniqname and password"
	@echo "You may need to run 'module load mongodb' as well on CAEN."
	mongoimport --host eecs484.eecs.umich.edu --username abrehob --password 12!4Tgooi6oo  --collection users --db abrehob --file  output.json --jsonArray
...
mongoquerytest:
	...
	@echo "You must edit the following line in Makefile to correct the uniqname and password"
	@echo "You may need to run 'module load mongodb' as well on CAEN."
	mongo abrehob -u abrehob -p 12!4Tgooi6oo --host eecs484.eecs.umich.edu < test.js
	echo "Local tests in test.js have been run."
	@echo "Optional: Do make dropdatabase to remove the mongo database."

dropdatabase:
	@echo "You must edit the following line in Makefile to correct the uniqname and password"
	mongo abrehob -u abrehob -p 12!4Tgooi6oo --host eecs484.eecs.umich.edu --eval "db.users.drop()"
